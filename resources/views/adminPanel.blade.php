...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3">View Member Activity Log</h4>
                </div>
                <a href="{{ route('user_audit_logs') }}" class="btn btn-primary btn-block">Go</a>
                <br>
            </div>

            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3">Manage Inventory</h4>
                </div>
                <a href="{{ route('inventory.index') }}" class="btn btn-primary btn-block">Go</a>
                <br>
            </div>

            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3">View Payment History</h4>
                </div>
                <a href="{{ url('/payment-history') }}" class="btn btn-primary btn-block">Go</a>
                <br>
            </div>
        </div>
    </div>
